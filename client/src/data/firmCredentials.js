/** ICAI and firm statutory identifiers — single source of truth for disclosures. */
export const ICAI_FIRM_REGISTRATION_NO = '012584C';
export const ICAI_FIRM_CATEGORY = 'I (One)';
export const FIRM_ESTABLISHED_YEAR = '2003';
